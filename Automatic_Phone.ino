...
void printHelp(void)
{
  ...
  Serial.println(F("clear     clear                     clear                      remove all record"));
 
  Serial.println(F("record   record (r0)           record 0                Check record train status"));
  Serial.println(F("vr          vr                         vr                          Check recognizer status"));
  Serial.println(F("getsig    getsig (r)              getsig 0                Get signature of record (r)"));
  Serial.println(F("sigtrain  sigtrain (r) (sig)   sigtrain 0 ZERO  Train one record(r) with 
                                                                                                     signature(sig)"));
